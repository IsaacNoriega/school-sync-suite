      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-6 space-y-6 pb-16">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="space-y-2">
            <div className="h-9 w-60 bg-slate-200 rounded-3xl animate-pulse" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[0, 1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-3xl p-5 border border-slate-100 space-y-3">
              ...
              <div className="h-10 w-16 bg-slate-200 rounded-2xl animate-pulse" />
        ...
        <div className="bg-white rounded-3xl border border-slate-100 overflow-hidden shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <div className="h-5 w-40 bg-slate-200 rounded-full animate-pulse" />
            <div className="h-9 w-32 bg-slate-200 rounded-2xl animate-pulse" />
          </div>
          <div className="divide-y divide-slate-100">
            {[0, 1, 2, 3, 4].map((i) => (
              <div key={i} className="p-4 flex items-center gap-4">
                ...
                <div className="h-8 w-8 bg-slate-200 rounded-2xl animate-pulse" />
              </div>
            ))}
          </div>
        </div>
