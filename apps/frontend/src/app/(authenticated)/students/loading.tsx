  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] select-none font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-6 space-y-6 pb-20">
        ...
        {/* Two-column layout skeleton: form + preview */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Form skeleton */}
          <div className="bg-white rounded-3xl p-6 border border-slate-100 space-y-5 shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 space-y-5 shadow-[0_2px_15px_rgba(0,0,0,0.02)]">
            ...
            {/* Badge preview */}
            <div className="bg-slate-100 rounded-3xl p-6 flex flex-col items-center gap-4">
